...
class TeaspoonLexer(RegexLexer):
    """
    Derived from TypeScriptLexer from Pygments
    """
    ...
    tokens = {
        ...
        'root': [
            ...
            (r'(var|let|const|with|function|class|type|enum|interface|inline|val|lazy)\b', Keyword.Declaration, 'slashstartsregex'), # CHANGE
